...
async def on_member_join(member):
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            "<:verified:1483008933365813330> Verify **[here](https://discord.com/channels/1441901639739904125/1471452917163884738)**."
        ),
        color=0x87CEFA
    )
...
async def startup(interaction: discord.Interaction):
    ...
    embed = discord.Embed(
        ...
        description=(
            ...
            "Please ensure your Roblox privacy settings are set to **everyone**.\n\n"
            "React with <:blueheart:1483008124024524820> to confirm presence.\n\n"
            f"Minimum reactions required: **{required_reactions}+**"
        ),
        color=0x87CEFA
    )
...
class LinkView(ui.View):
    ...
    async def join(self, interaction: discord.Interaction, button: ui.Button):
        ...
        embed = discord.Embed(
            ...
            description=f"[Join Server]({self.url})",
            color=0x87CEFA
        )
...
async def link(interaction: discord.Interaction, url: str):
    ...
    embed = discord.Embed(
        ...
        description=f"{interaction.user.mention} has released the convoy session.",
        color=0x87CEFA
    )
